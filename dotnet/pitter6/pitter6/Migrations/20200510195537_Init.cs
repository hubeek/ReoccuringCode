    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PerformanceTypeId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Name = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerformanceTypes", x => x.PerformanceTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOptionalTime = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "PerformanceTypeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "PerformanceTypeId", "Name" },
                values: new object[] { 1, "Show" });

            migrationBuilder.InsertData(
                table: "PerformanceTypes",
                columns: new[] { "PerformanceTypeId", "Name" },
                values: new object[] { 2, "Rehearsal" });

            migrationBuilder.InsertData(
                table: "PerformanceTypes",
                columns: new[] { "PerformanceTypeId", "Name" },
                values: new object[] { 3, "Run-through" });

            migrationBuilder.InsertData(
                table: "PerformanceTypes",
                columns: new[] { "PerformanceTypeId", "Name" },
                values: new object[] { 4, "SoundCheck" });

            migrationBuilder.InsertData(
                table: "PerformanceTypes",
                columns: new[] { "PerformanceTypeId", "Name" },
                values: new object[] { 5, "Press-presentation" });
